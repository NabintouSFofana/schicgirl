...
var COURSES=[
 ...
 {id:'crs-scalp',icon:'🌿',file:'pellicules',
  ten:'Goodbye Dandruff — Healthy Scalp',tfr:'Adieu Pellicules — Cuir Chevelu Sain',
  sen:'Calm flakes & itch for good: dry vs oily, the real causes, the scalp routine, DIY treatments — and when to see a doctor.',
  sfr:'Fini pellicules & démangeaisons : sèches ou grasses, les vraies causes, la routine, soins maison — et quand consulter.'},
 {id:'crs-transition',icon:'🦋',file:'transition',
  ten:'Transition — No Big Chop',tfr:'Transition — Sans Big Chop',
  sen:'Go natural without cutting it all: protect the fragile line of demarcation, blend two textures, and pace the trim.',
  sfr:'Passe au naturel sans tout couper : protège la ligne de démarcation fragile, marie deux textures, et coupe à ton rythme.'},
