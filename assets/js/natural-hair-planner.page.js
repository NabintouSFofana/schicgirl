var EBOOK = {"slug": "natural-hair-planner", "img_fr": "assets/natural-hair-planner-fr.webp", "img_en": "assets/natural-hair-planner-en.webp", "url_fr": "https://selar.com/planificateur", "url_en": "https://selar.com/natural-hair-planner", "price_fr": "9€", "price_en": "$10", "price_cfa": "≈ 5 900 FCFA", "cta_fr": "Obtenir mon carnet →", "cta_en": "Get my planner →"};
  var LANG = "fr";
  ...
  function render(){
    ...
    if (cov){ var src = T(EBOOK,"img"); if(src){ var _cs = ab(src); cov.setAttribute("src", _cs + (_cs.indexOf("?")<0?"?v=20260726":"")); } }
